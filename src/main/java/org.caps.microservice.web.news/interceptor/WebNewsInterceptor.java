package org.caps.microservice.web.news.interceptor;
...
import org.caps.microservice.common.web.interceptor.BaseInterceptorMethods;
import org.caps.microservice.web.news.service.RedisService;
...
public class WebNewsInterceptor implements HandlerInterceptor {
    @Autowired
